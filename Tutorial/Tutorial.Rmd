...
1.  Expand on the Coding Club tutorial "Transforming and Scaling Data"
2.  Use model outputs to produce allometric equations on preferred variables

# Steps

1.  Choose your preferred variables
2.  Modify the data to prepare it for the model
3.  Apply an appropriate model
4.  Extract relevant coefficients from the model to produce allometric equations
5.  Quantify errors associated with the allometric equation

If you have ever created a model before, you remember the wealth of coefficients and significance values that it produces. Say your model is on two variables, but one of them was really difficult to measure and you only got data from a few points of a possible range of values. Some of the coefficients from the model can be used to create a formula to predict new values of the difficult variable that you haven't previously observed, which is called an 'allometric equation'.
...
This tutorial works with a large data set on destructively sampled biomass structure of trees in Eurasia, which can be found here: <https://www.nature.com/articles/sdata201770#Sec3>
...
```{r}
# Loading the data
  # Use the exact name for 'sheet' for Excel files with multiple sheets
...
# 2. Investigate the distribution of the variables
...
```{R, echo=FALSE}
knitr::include_graphics("/Users/mano/Documents/Uni/Third Year/Data Science/Challenge 4/tutorial-luisasenecio/DBH distribution.png")
```
...
```{R, echo=FALSE}
knitr::include_graphics("/Users/mano/Documents/Uni/Third Year/Data Science/Challenge 4/tutorial-luisasenecio/Ptot distribution.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("/Users/mano/Documents/Uni/Third Year/Data Science/Challenge 4/tutorial-luisasenecio/log10 DBH distribution.png")
```

```{r, echo=FALSE}
knitr::include_graphics("/Users/mano/Documents/Uni/Third Year/Data Science/Challenge 4/tutorial-luisasenecio/log10 Ptot distribution.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("/Users/mano/Documents/Uni/Third Year/Data Science/Challenge 4/tutorial-luisasenecio/log10 model output.png")
```
...
```{r, echo=FALSE}
knitr::include_graphics("/Users/mano/Documents/Uni/Third Year/Data Science/Challenge 4/tutorial-luisasenecio/Q-Q plot log10 model.png")
```
...
# 4. Extracting the coefficients for an allometric model
